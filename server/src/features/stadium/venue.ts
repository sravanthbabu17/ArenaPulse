...
export const VENUE_DATASET: VenueDataset = {
  ...
  facilities: {
    medical: [
      {
        location: "Section 102 (Lower Tier)",
        name: "Central First Aid Station",
        services: "Full medical triage, defibrillator, stretcher transport",
      },
      {
        location: "Section 308 (Upper Tier)",
        name: "Satellite First Aid Room",
        services: "Basic first aid, heat exhaustion care",
      },
    ],
    restrooms:
      "Located at every concourse exit near the ramps. Dedicated family and accessible restrooms are placed adjacent to Sections 105, 215, and 325.",
    elevators: [
      {
        name: "West VIP Lobby Elevators",
        accessTo: "All tiers, VIP Suites, and Press Zone",
      },
    ...
    sensoryRoom: {
      ...
      purpose:
        "Quiet space for neurodivergent fans, sensory bags, and noise-canceling headphones available.",
    },
  },
  ...
  transit: {
    metro: {
      ...
      accessibility:
        "Elevators to platform, tactile paving, wheelchair boarding slots.",
    },
    shuttles: {
    ...
    rideshare: {
      ...
      waitTimes:
        "Typically 15-20 minutes, priority lanes for accessible rides.",
    },
  },
};
